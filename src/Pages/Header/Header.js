                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto">
                            ...
                            <Nav.Link href="#link" className='text-white fw-bold'>Merchandise</Nav.Link>
                            ...
                            {user ? <button onClick={handleSignOut} className='btn btn-danger'> Sign out </button> : <Nav.Link as={Link} to="/login" className='text-danger fw-bold'>Sign In</Nav.Link>}
                        </Nav>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
